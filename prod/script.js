...
(function () {
  ...
  var promises = [d3.json("https://d3js.org/us-10m.v1.json"), d3.json("https://script.google.com/macros/s/AKfycbyb3boypqtiarqme4ezOcFqWF8HCU_RNjXFPoo9ThtWA16Qr68r/exec?id=1nik6jVxBoGdvrOtfnbCgfiXejeYdBMYQWCjTKbYwZwo"), d3.tsv("https://s3.amazonaws.com/interactives.commonwealthfund.org/2020/maternal-health-policy-map/data/state-names.tsv", function (d) {
  ...
  function createMap(us, map, type) {
    ...
    legendCircle.enter().append("circle").attr("cx", 25).attr("cy", function (d, i) {
      return 40 + i * 35;
    ...
    legendText.enter().append("text").attr("x", 45).attr("y", function (d, i) {
      return 40 + i * 35;
